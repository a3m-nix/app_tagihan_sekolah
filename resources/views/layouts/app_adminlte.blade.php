...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand bg-primary navbar-light bg-info">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 d-flex border-bottom-0">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Helo, {{ Auth::user()->name }}</a>
                    </div>
                </div>
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <a href="{{ route('userprofil.edit', 0) }}">Anda Login sebagai {{ Auth::user()->akses }} <i
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('biaya.index') }}"
                                class="nav-link {{ request()->is('biaya*') ? 'active' : '' }}">
